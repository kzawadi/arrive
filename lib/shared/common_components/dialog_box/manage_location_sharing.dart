...
Future<void> manageLocationSharing(GlobalKey<NavigatorState> navKey) {
...
//todo another location logic in UI to fix
  ...
  Future<void> _changeLocationSharing(
      LocationSharingData _locationSharingData, bool _value) async {
    final locationNotificationModel = _locationSharingData
