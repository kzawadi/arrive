...
typedef ClusterWidgetBuilder = Widget Function(
    BuildContext context, List<fm.Marker?> markers);

class MarkerClusterLayerOptions extends fm.LayerOptions {
  /// Cluster builder
  ...
  final Size Function(List<fm.Marker?>)? computeSize;

  /// Cluster anchor
  final fm.AnchorPos? anchor;

  /// A cluster will cover at most this many pixels from its center
  final int maxClusterRadius;

  /// Options for fit bounds
  final fm.FitBoundsOptions fitBoundsOptions;
  ...
  final void Function(fm.Marker?)? onMarkerTap;

  /// Function to call when markers are clustered
  final void Function(List<fm.Marker?>)? onMarkersClustered;
  ...
  MarkerClusterLayerOptions({
    ...
    this.fitBoundsOptions =
        const fm.FitBoundsOptions(padding: EdgeInsets.all(12.0)),
...
// class MarkerClusterPlugin extends plugin.MapPlugin {
//   final Key key;
//   MarkerClusterPlugin(this.key);
//   @override
//   Widget createLayer(
//       fm.LayerOptions options, plugin.MapState? mapState, Stream<void> stream) {
