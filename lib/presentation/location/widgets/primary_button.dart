import 'package:atsign_location_app/presentation/location/widgets/squircle_border.dart';
...
class ArrivePrimaryButton extends StatefulWidget {
  const ArrivePrimaryButton({
    Key? key,
    this.prefixIcon,
    this.suffixIcon,
    this.buttonText,
...
class _ZawadiPrimaryButtonState extends State<ArrivePrimaryButton>
  ...
  @override
  void didUpdateWidget(ArrivePrimaryButton old) {
            ...
            child: DecoratedBox(
              ...
              child: Container(
                ...
                padding: widget.padding ??
                    ((![Colors.transparent, null].contains(widget.color))
                        ? _kBackgroundButtonPadding
                        : _kButtonPadding),
                child: (![Colors.transparent, null].contains(widget.color))
                    ? Row(
                        mainAxisAlignment:
